...
const defaultReviews = [
  {
    name: "Sarah Chisamba",
    role: "Corporate Consultant • Guest Stay",
    rating: 5,
    text: "I stayed at ARMAN Lodge for three weeks during a business trip to Kwekwe. The backup power was a lifesaver — I never missed a Zoom call. The WiFi was stable, Netflix was great, and daily housekeeping made it feel like a hotel. Newtown is peaceful and safe!"
  },
  {
    name: "Michael van Wyk",
    role: "Mining Operations Manager • Guest Stay",
    rating: 5,
    text: "We've been staying in the executive suite at ARMAN Lodge for our regular monthly trips and we love it. The gas geyser means hot water any time, the backup power keeps things running, and the night guard gives us total peace of mind. Best accommodation in Newtown."
  },
  {
    name: "Tinashe Moyo",
    role: "Tech Entrepreneur • Guest Stay",
    rating: 5,
    text: "Spent a wonderful weekend at ARMAN Lodge with my family. The suite was clean, fully self-catered, and had everything we needed — DStv, Netflix, air cooler, tea and coffee. You can feel this is a family-run place that genuinely cares about guests."
  }
];
